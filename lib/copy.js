...
export const copy = {
  ...
  hero: {
    ...
    trustChips: [
      ...
      { icon: "🛡️", text: "Preko 80% popusta danas" },
    ],
  },
  ...
  finalCta: {
    ...
    subUrgency:
      "Ne propustite priliku da nabavite knjigu recepata uz 80% popusta. Transformišite svoje zdravlje već sada uz naš kompletan jelovnik za 365 dana.",
  ...
  faq: {
    ...
    doesntWorkHeadline: "ŠTA NE DELUJE: ❌",
    doesntWork: [
    ...
    items: [
      { q: "KAKO ĆU DOBITI RECEPTE?", a: "Celokupan sadržaj ćete dobiti na vašu imejl adresu odmah nakon uplate." },
      { q: "MOGU LI DA PRISTUPIM SA TELEFONA?", a: "Da, možete pristupiti receptima sa telefona, tableta ili računara." },
  ...
  footer: {
    brand: "Crearis",
    copyright: "2026 © Sva prava zadržana. Upoznajte se sa našom Politikom privatnosti.",
  },
};